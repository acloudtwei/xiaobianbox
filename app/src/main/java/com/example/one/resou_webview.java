...
public class resou_webview extends AppCompatActivity {

    private List<String> weibo_urls = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_resou_webview);
        SharedPreferences sp = Objects.requireNonNull(resou_webview.this).getSharedPreferences("weibo", Activity.MODE_PRIVATE);
    ...
    public void view_webview(int position){
        ...
        webView.setWebViewClient(new WebViewClient(){
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                //设定加载开始的操作
                Toast.makeText(resou_webview.this,"加载中...",Toast.LENGTH_SHORT).show();
            }

        });
    }

    public void resou_listview(View view)
    {
